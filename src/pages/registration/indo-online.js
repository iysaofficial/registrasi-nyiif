...
function IndonesiaOnline() {
  ...
  const scriptURL = "https://script.google.com/macros/s/AKfycbzo8KkMu2OmT2FraUjAyk-uRijj6AVoQs8vFouczFuCtKroTdLdH2mCBpIqbSKJq0Wv/exec";
  ...
  return (
    <>
      <Head>
        <title>Indo Online | NYIIA</title>
        <meta name="description" content="Halaman Registrasi NYIIA" />
      </Head>
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="NYIIA Website">NYIIA Website</option>
                    <option value="IYSA Website">IYSA Website</option>
                    <option value="IYSA Instagram">IYSA Instagram</option>
                    <option value="NYIIA Instagram">NYIIA Instagram</option>
                    ...
                    <option value="NYIIA Email">NYIIA Email</option>
